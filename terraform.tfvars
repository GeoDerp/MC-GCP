...
vm_startupscript =  "sudo mkdir -p /home/data && sudo chmod -R u=rwx /home/data && cd /home/data && git clone https://github.com/GeoDerp/MC-GCP && cd MC-GCP && sleep 5 && chmod +x run.sh && sudo bash ./run.sh"
restartPolicy = "Never"
preemptible = "false"
